...
class Snake:
    ...
    def __init__(self):
        ...
        # Set the color of the snake's head
        canvas.itemconfig(self.squares[0], fill=SNAKE_HEAD_COLOR)
...
def game_over():
    ...
    retry_button = Button(window, text="Retry", font=('consolas', 20), bg="green", fg="white", command=restart_game)
    retry_button.pack()
